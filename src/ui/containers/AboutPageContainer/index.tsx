import { OriginalLogoSVG } from "@public/vectors";
  ...
  return (
    <div className="flex flex-col gap-y-12 px-20 pt-12 pb-36 bg-white text-gray-800">
      <div className="text-center ">
        <h1 className="text-64px700 font-bai">{t("title")}</h1>
      </div>
      <div className="flex flex-col items-center py-10 text-center bg-gray-50 rounded-3xl">
        <OriginalLogoSVG />
      </div>
      <div className="flex flex-col px-64 text-start gap-y-5 font-inter">
      ...
      <div className="flex flex-col px-64 text-start gap-y-5">
        <h2 className="text-24px600 text-gray-800">
          Sollicitudin habitant viverra ornare
        </h2>
        <p className="text-gray-500 text-16px500">
      ...
      <div className="mx-auto grid md:grid-cols-2 gap-x-6  items-center">
        <Image
          src={MockImage} 
          alt="Building"
          width={900}
